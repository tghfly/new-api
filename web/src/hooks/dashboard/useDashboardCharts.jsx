...
import { semiDesignLight } from '@visactor/vchart-semi-theme';
...
export const useDashboardCharts = (
  ...
  // ========== 初始化图表主题（强制浅色模式，不依赖 CSS 变量） ==========
  useEffect(() => {
    const themeName = 'semiDesignLight';
    if (!VChart.ThemeManager.themeExist(themeName)) {
      VChart.ThemeManager.registerTheme(themeName, semiDesignLight);
    }
