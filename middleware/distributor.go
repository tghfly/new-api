	...
	return func(c *gin.Context) {
		...
		if ok {
			...
			if shouldSelectChannel {
				...
				// check path is /pg/chat/completions or /llmapi/pg/chat/completions
				if strings.HasPrefix(c.Request.URL.Path, "/pg/chat/completions") || strings.HasPrefix(c.Request.URL.Path, "/llmapi/pg/chat/completions") {
...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.NewAPIError {
	...
	// TODO 日志中增加 组织和标签字段
	if nil != channel.Tag && *channel.Tag != "" {
